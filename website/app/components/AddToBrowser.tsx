  ...
  return (
    <div className="relative">
      <Link
        to={browser.link}
        prefetch="viewport"
        className="inline-flex items-center justify-center font-bold gap-2 bg-white text-black rounded-full px-4 py-2"
      >
      ...
      {browser.name === "Microsoft Edge" && (
        <Popover>
          <>
            ...
            >
              <Popover.Panel className="text-black text-pretty absolute left-1/2 z-10 mt-7 w-screen max-w-sm -translate-x-1/2 transform px-4 sm:px-0 lg:max-w-3xl">
