...
export class Selector {
  ...
  private readonly onElementSelected: (element: HTMLElement) => void
  private readonly mouseoverHandler = (event: Event) => {
  ...
  private readonly clickHandler = (event: Event) => {
    ...
    // The jump event of click internal link in Vue SPA is not a default event and cannot be prevent.
...
const getTagPath = (element: HTMLElement) => {
