...
<template>
  ...
  >
    ...
    <div
      ...
      class="fixed h-4 w-4 cursor-pointer rounded-full shadow-md transition-[top,left] duration-300 [transform:translate(-50%,-50%)] hover:transition-none focus:transition-none"
      tabindex="0"
      :style="shadeBarStyle"
    ...
    <div
      ...
      class="fixed h-3 w-3 cursor-pointer rounded-full shadow-md transition-[top,left] duration-300 [transform:translate(-50%,-50%)] hover:transition-none focus:transition-none"
      tabindex="0"
      :style="hueBarStyle"
